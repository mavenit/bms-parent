...
public class AssetController extends AbstractModelController<PropAssets,String> {
	...
	@Override
	public ResponseEntity<JsonNode> processCreate(@Validated @Valid @RequestBody PropAssets reqJson,@RequestParam("file") MultipartFile multipartFile) throws ServiceException {
