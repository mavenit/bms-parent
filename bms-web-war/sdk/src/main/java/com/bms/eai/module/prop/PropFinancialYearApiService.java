 ...
 */
@Service
public class PropFinancialYearApiService extends AbstractPropDetailsRestApiClient<PropFinanceYear, JsonResponseBean> implements SimpleDataAccess<PropFinanceYear>{
	...
	public JsonResponseBean create(PropFinanceYear t) throws ResourceAccessException, Exception {
		logger.info("SDK CREATE ......");
		return this.processOperations(null,CREATE,t);
		//return null;
	}

	public JsonResponseBean update(String updateId, PropFinanceYear t) throws ResourceAccessException, Exception {
		return null;
	}
