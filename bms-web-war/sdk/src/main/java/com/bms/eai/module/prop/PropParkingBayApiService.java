...
public class PropParkingBayApiService
		extends AbstractPropDetailsRestApiClient<PropParkingBayDetails, JsonResponseBean> implements SimpleDataAccess<PropParkingBayDetails> {
	...
	public JsonResponseBean create(PropParkingBayDetails t) throws ResourceAccessException, Exception {
		logger.info("SDK CREATE ......");
		return this.processOperations(null,CREATE,t);
		//return null;
	}

	public JsonResponseBean update(String updateId, PropParkingBayDetails t) throws ResourceAccessException, Exception {
		return null;
	}
