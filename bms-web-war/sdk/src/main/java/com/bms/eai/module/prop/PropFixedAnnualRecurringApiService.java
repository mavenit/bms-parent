...
public class PropFixedAnnualRecurringApiService
		extends AbstractPropDetailsRestApiClient<PropFixedAnualRecurring, JsonResponseBean> implements SimpleDataAccess<PropFixedAnualRecurring>{

	private JsonResponseBean processOperations(String updatePropDetailsMasterId, String screenFlag,
	...
	public JsonResponseBean create(PropFixedAnualRecurring t) throws ResourceAccessException, Exception {
		logger.info("SDK CREATE ......");
		return this.processOperations(null,CREATE,t);
		//return null;
	}

	public JsonResponseBean update(String updateId, PropFixedAnualRecurring t) throws ResourceAccessException, Exception {
		return null;
	}
